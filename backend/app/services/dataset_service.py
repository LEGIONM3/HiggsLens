...
class DatasetService:
    """Service providing dataset summaries for statistical Higgs-event classification on CERN/ATLAS open data."""

    def get_summary(self) -> DatasetSummaryResponse:
        return DatasetSummaryResponse(
            event_count=settings.TOTAL_EVENT_COUNT,
            features=FEATURE_NAMES,
            source=settings.CERN_SOURCE,
            doi=settings.CERN_DOI
        )
